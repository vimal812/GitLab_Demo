...
const Navbar = () => {
  ...
  return (
    <div className="bg-violate text-white d-flex justify-content-between p-2">
      ...
      <div className="d-flex">
        ...
        <div className="me-5 bg-light-violate pe-2 br-3 d-flex  align-items-center">
          <input
            type="text "
            className="bg-light-violate border-0 text-light-blue ps-2 outline-none search_input"
